...
g++ -o PlatformSDL.o        -c PlatformSDL.cpp         $OPTIONS -fPIC -Wall -Wextra -I. -Wno-unknown-pragmas || exit;
echo "PlatformSDL.o"
g++ -o FilterScript.o       -c FilterScript.cpp        $OPTIONS -fPIC -Wall -Wextra -I. -Wno-unknown-pragmas -Wno-write-strings || exit;
echo "FilterScript.o"
g++ -o FilterCopy.o         -c FilterCopy.cpp          $OPTIONS -fPIC -Wall -Wextra -Wno-write-strings || exit;
echo "FilterCopy.o"
